 ...
 * [[com.datasift.dropwizard.hbase.config.HBaseClientConfiguration]] directly and
 * configure each instance manually in your Service.
 */
trait HBaseConfiguration {
  self: Configuration =>

  /**[[com.datasift.dropwizard.hbase.config.HBaseClientConfiguration]] for the HBase client */
  @BeanProperty
  @Valid
